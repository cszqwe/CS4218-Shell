...
public class HackatonTests {
    ...
    */
	...
	/**
	 *
	 * Expected: Prints number of lines in the file, followed by the filename and then a newline.
	 * Actual : Prints number of lines in the file without filename, followed by a newline.
	 * Description : wc -l < filename should print the number of lines, with the filename. It works fine if not using < operator.
	 * Reference : Filename is printed based on the group's assumption, not project description (not specified).
	 * @throws ShellException
	 * @throws AbstractApplicationException **
	 *
	 */
	@Test
	public void testWcInputRedirectedFile() throws AbstractApplicationException, ShellException {
	    String cmdLine = "wc -l < " + filePath;
	    String expected = "2 " + filePath + "\n";
