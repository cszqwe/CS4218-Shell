...
public class CalApplication implements Cal {
	/*
	 * Assumption: Month is entered as number instead of word e.g. (6 instead of
	 * june)
	 * 
	 */
	...
	String[] monthIntToString = { null, "January", "February", "March", "April", "May", "June", "July", "August",
	...
	public String processResultArray(String[][] arrayResult, String year) {
		...
		for (int i = 0; i < 4; i++) {
			...
			// System.out.println(colOneLength + " " + colTwoLength + " " +
			// colThreeLength);
			...
			for (int j = 0; j < minColLength; j++) {
				result += colOneSplit[j] + "  " + colTwoSplit[j] + "  " + colThreeSplit[j];
